import 'package:evfinder_front/View/Widget/BnB/add_charge_card.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import '../../../../Controller/MainPage/ChargerBnB/Charger/addCharge_controller.dart';
import '../../../../Controller/MainPage/ChargerBnB/Charger/charge_detail_controller.dart';
            ...
            child: TextButton(
              onPressed: () async {
                ...
                if (create == true) {
                  ...
                  Get.snackbar('', '새 충전소가 등록되었습니다.', snackPosition: SnackPosition.BOTTOM);
                }
              },
              ...
              child: const Text('+ 새 충전소 등록', style: TextStyle(fontWeight: FontWeight.w600)),
            ),
          ),
        ],
      ),
